...
router.put('/updateSection', isAuthenticate, isInstructor, updateSection);

// Route to delete a section, protected by authentication and instructor role
router.delete('/deleteSection/:courseId/:sectionId', isAuthenticate, isInstructor, deleteSection);
